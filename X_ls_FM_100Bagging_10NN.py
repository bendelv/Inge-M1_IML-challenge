...
if __name__ == '__main__':
    ...
    model = BaggingRegressor(KNeighborsRegressor(10), n_estimators = 100, max_samples= 0.5, bootstrap = False, max_features = 0.5)

    print('Begin CV..')

    scores = cross_val_score(model, X_ls, y_ls, scoring= 'neg_mean_squared_error', cv=3, n_jobs = -1)
